...
`ralph-manual.sh` - Run one task at a time. You control when each iteration runs. Good for watching output and staying in control before going fully autonomous.
