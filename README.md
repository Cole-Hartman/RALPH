...
my-project/
  ...
  │
  └── .ralph/
      ├── ralph.sh              # Loop runner (you provide)
      ├── prompt.md             # Agent instructions (you provide)
      │
      ├── PRD.md                # Feature overview (generated by /prd)
      ├── TRACK.md              # Tasks & state (generated by /prd)
      ├── progress.txt          # Iteration log (generated by /prd)
      └── prd.md                # PRD template (you provide)
```
